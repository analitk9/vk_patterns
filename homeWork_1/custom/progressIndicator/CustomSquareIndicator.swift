...
class CustomSquareIndicator: UIActivityIndicatorView {
    ...
    override func startAnimating() {
        self.backgroundColor = UIColor.vkColor.backGround
        
        myLayer.path = nil
        myLayer.lineWidth = 4
        
        myLayer.strokeColor = UIColor.vkColor.strokeColor.cgColor
        myLayer.fillColor = UIColor.vkColor.fillColor.cgColor
